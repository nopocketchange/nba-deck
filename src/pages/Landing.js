...
</svg></span>{toggle?<span><img style={{width:'100px', height:'100px'}} src={data[toggle].img} alt={data[toggle].team} /></span>:<span>🏀</span> } <span className="next" onClick={increase}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
